...
def add_new_product():
    ...
    database.add_product(p_name,p_rate,weight,w_unit,p_desc,category,Dimension,'/static/images/Product_img/Milk.jpg','/static/images/Product_qr/QR_CODE.png',placement,'Raj','2022-01-01',quantity,quan_unit,fragile,min_quan,10,s_rate)
...
def more_details_products(pid):
    ...
    return render_template('more_product_details.html', data=data)
